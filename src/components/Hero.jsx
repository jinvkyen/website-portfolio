    ...
    <section className='px-6 md:px-28 py-20'>
      <div className='grid grid-cols-1 md:grid-cols-2 gap-10 items-center'>
        ...
        <div className='transition-all duration-500 animate-fadeIn'>
          ...
          <p className={`md:text-2xl ${theme.text} ${theme.accent} max-w-2xl mb-8`}>
        ...
        <div className='w-full'>
          <div className='aspect-w-1 aspect-h-1'>
            <iframe
              ...
              web-share='true'
              src='https://sketchfab.com/models/b5d316548d634f16a72dd503db0aa01b/embed?autostart=1&ui_infos=0&ui_controls=0&ui_stop=0 '
              className='w-full h-[300px] md:h-[400px] rounded-md shadow-md'></iframe>
          </div>
